...
def test_connect():
    ...
    emit('strange_detected', {'data': 'Connected', 'count': 0})

#이상행동 발견 시 알림보내기
def alarmToWebWhenStrangeDetected():
    print("alarmToWebWhenStrangeDetected 들어옴")
    socketio.emit('strange_detected',
         {'data': '이상행동 발견된다!', 'count': '10'},namespace='/test')
...
if __name__ == '__main__':
    ...
    socketio.run(host="0.0.0.0",debug = True, use_reloader=False)
