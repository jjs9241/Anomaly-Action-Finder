                ...
                <div id="content">
                    ...
                    <div class="table">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="name"><a href="/cctvlist">super</a></td>
                                    <td class="storeid">1234</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td class="name"><a href="#">mart</a></td>
                                    <td class="storeid">5678</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td class="name"><a href="#">shop</a></td>
                                    <td class="storeid">2345</td>
                        ...
                        <div class="table_footer">
                            ...
                            <button type="button"><a href="/createshop"><i class="fas fa-plus-circle"></i>Add New shop</a></button>
                        </div>
                    </div>
                <!--//content-->
            </div>  
